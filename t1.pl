...
%verifica se o caminho se encontra desimpedido na horizontal/vertical e verifica se a peca se encontra nessas posicoes
...
%verifica se o caminho se encontra desimpedido na diagonal e verifica se a peca se encontra nessas posicoes
...
%verifica se as coordenas escolhidas sao coerentes com o movimento do cavalo
...
%verifica se o jogador joga as suas pecas
...
gameoverbot(1,NovoTabuleiro):-findall(Xi-Yi-Xf-Yf,(getPeca(Xi,Yi,P,NovoTabuleiro),(P == ' T ' ; P == ' B '; P == ' H '; P == ' Q '),getPeca(Xf,Yf,P2,NovoTabuleiro),(P2 == ' t ' ; P2 == ' b '; P2 == ' h '; P2 == ' q '),validmove(Xi,Yi,Xf,Yf,P,P2,NovoTabuleiro)),Q),length(Q,E),(E > 0);(printab(NovoTabuleiro),nl,write('Game Over. Bot wins'),fail),!.
gameoverbot(2,NovoTabuleiro):-findall(Xi-Yi-Xf-Yf,(getPeca(Xi,Yi,P,NovoTabuleiro),(P == ' t ' ; P == ' b '; P == ' h '; P == ' q '),getPeca(Xf,Yf,P2,NovoTabuleiro),(P2 == ' T ' ; P2 == ' B '; P2 == ' H '; P2 == ' Q '),validmove(Xi,Yi,Xf,Yf,P,P2,NovoTabuleiro)),Q),length(Q,E),(E > 0);(printab(NovoTabuleiro),nl,write('Game Over. Player 1 wins'),fail),!.
...
printboardbot(Tabuleiro,NovoTabuleiro,Player,Dificulty):-printab(Tabuleiro),(Dificulty == 'e' -> getmovebot(Xi,Yi,Xf,Yf,Tabuleiro,Player);(Dificulty == 'm' -> getmovebotM(Xi,Yi,Xf,Yf,Tabuleiro,Player));(Dificulty == 'h' -> getmovebotH(Xi,Yi,Xf,Yf,Tabuleiro,Player))),move(Xi,Yi,Xf,Yf,Tabuleiro,NovoTabuleiro,Player),!.
%ciclo usado para player vs player
cicle(Tabuleiro,2):-gameover(2,Tabuleiro),!,gameover(1,Tabuleiro),printurn(2),printboard(Tabuleiro,NovoTabuleiro,2),changeplayer(2,P2),!,cicle(NovoTabuleiro,P2).
cicle(Tabuleiro,1):-gameover(1,Tabuleiro),!,gameover(2,Tabuleiro),printurn(1),printboard(Tabuleiro,NovoTabuleiro,1),changeplayer(1,P2),!,cicle(NovoTabuleiro,P2).
%ciclo usado para bot vs player
ciclebot(Tabuleiro,2,Dificulty):-gameoverbot(2,Tabuleiro),!,gameoverbot(1,Tabuleiro),printurnbot(2),printboardbot(Tabuleiro,NovoTabuleiro,2,Dificulty),changeplayer(2,P2),!,ciclebot(NovoTabuleiro,P2,Dificulty).
ciclebot(Tabuleiro,1,Dificulty):-gameoverbot(1,Tabuleiro),!,gameoverbot(2, Tabuleiro),printurnbot(1),printboard(Tabuleiro,NovoTabuleiro,1),changeplayer(1,P2),!,ciclebot(NovoTabuleiro,P2,Dificulty).
%ciclo usada para bot vs bot
ciclebotbot(Tabuleiro,Player,Dificulty):-gameoverbotbot(1,Tabuleiro),!,gameoverbotbot(2,Tabuleiro),printurnbotbot(Player),printboardbot(Tabuleiro,NovoTabuleiro,Player,Dificulty),changeplayer(Player,P2),!,ciclebotbot(NovoTabuleiro,P2,Dificulty).
...
write('Pick a Game Mode: pvp/pvb/bvb'),nl,nl, read(Choice), (Choice == 'pvp' -> xadrez;Choice == 'pvb' -> (write('Pick Game Dificulty: Easy(e), Medium(m), Hard(h)') ,read(Input),bot(Input));Choice == 'bvb' ->(write('Pick Game Dificulty: Easy(e), Medium(m), Hard(h)') ,read(Input),botbot(Input))).
